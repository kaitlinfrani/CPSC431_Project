...
function applyFilters() {
  ...
  for (const provider of providers) {
    const occupation = provider
      .querySelector(".provider-occupation")
      .textContent.toLowerCase();
    const zipcode = provider
      .querySelector(".provider-zipcode")
      .textContent.toLowerCase();
    const foodPreference = provider
      .querySelector(".provider-food_preference")
      .textContent.toLowerCase();
    const availability = provider
      .querySelector(".provider-availability")
      .textContent.toLowerCase();
